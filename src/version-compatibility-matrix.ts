...
export class VersionCompatibilityMatrix {
    constructor(project: cdk.JsiiProject, config: VersionCompatibilityMatrixOptions) {
        const versionFileUpdateScript = new UpdateVersionFile(project, {
            underlyingTerraformProviderVersion: config.underlyingTerraformProviderVersion,
